...
public class MainMenu {
    ...
    private void createBoard() throws SQLException{
        ...
        System.out.println("Seu board terá colunas além das 3 padrões? Se sim informe quantas, senão digite 'B'");
    ...
    private BoardColumnEntity createColumn(final String name,
